...
df = pd.DataFrame(data=viable_cells, index=hours, columns=['viable_cells'])
binary = hours.diff()>=24 #returns True where hour difference > 24
trueindices = binary[binary['hours']==True].index.tolist()
